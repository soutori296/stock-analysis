...
with st.expander("📘 取扱説明書 (最終分析ロジック)"):
    ...
    <table class="desc-table">
        <tr><th style="width:20%">分類</th><th style="width:20%">基準額 (億円)</th><th style="width:15%">目標</th><th>順張り目標価格</th></tr>
        <tr><td><b>超大型株</b></td><td>10,000 億円 以上</td><td>1.5%</td><td rowspan="5">半益: 推奨買値<br>全益: 推奨買値</td></tr>
