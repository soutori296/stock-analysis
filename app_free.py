...
if st.session_state.analyzed_data:
    ...
    def create_table(d_list, title):
        ...
        headers = [
            ...
            ("戦略/\n水準", "75px", "🔥順張り: パーフェクトオーダーなど。🌊逆張り: RSI30以下など。"), 
            ("現在値", "60px", None), 
            ("買付水準\n(乖離)", "65px", "戦略に基づくエントリーの目安水準。乖離は現在値との差額。"), # ★ 修正
            ("R/R比", "40px", "最重要:想定買付水準から半益目標までの値幅を、SL MAまでの値幅で割った比率。1.0未満は-25点。"), 
            ...
            ("押し目買い\n勝敗数", "70px", "過去75日のバックテストにおける、想定エントリー（押し目）での勝敗数。"), 
