...
<style>
    ...
    .desc-indiv-risk { color: #FF9800; font-weight:bold; }
</style>
""", unsafe_allow_html=True)

with st.expander("📘 取扱説明書 (最終分析ロジック)"):
    # HTMLタグが丸見えになるのを防ぐため、可能な限りMarkdownとCSSで表現
    st.markdown("""
    ...
    <table class="desc-table">
        ...
        <tr><td>**超大型株**</td><td>10,000 億円 以上</td><td>1.5%</td><td rowspan="5">半益: 推奨買値 * (1 + $T_{pct}$ / 2)<br>全益: 推奨買値 * (1 + $T_{pct}$)</td></tr>
    ...
    <table class="desc-table">
        ...
        <tr><td class="desc-risk">**構造的リスク減点**</td><td colspan="3">**投資適格性フィルター。以下の合計最大-80点。**</td></tr>
        <tr><td>R/R比 不利</td><td>$\text{R/R比} < 1.0$</td><td>**-25点**</td><td>リワードがリスクを下回る。</td></tr>
        <tr><td>RSI極端 (大型株G)</td><td>🔥順張りでRSI $\ge 85$ / 🌊逆張りでRSI $\le 20$</td><td>**-15点**</td><td>大型株のトレンド継続性を許容 (時価総額 $\ge 3000$億円)。</td></tr>
        <tr><td>RSI極端 (小型株G)</td><td>🔥順張りでRSI $\ge 80$ / 🌊逆張りでRSI $\le 20$</td><td>**-25点**</td><td>小型株の急落リスクを厳しく評価 (時価総額 $\lt 3000$億円)。</td></tr>
        <tr><td>流動性不足(致命的)</td><td>5日平均出来高が 1,000株未満</td><td>**-30点**</td><td>換金リスクが極めて高い。</td></tr>
        
        <tr><td class="desc-add">**戦略/トレンド加点**</td><td colspan="3">**以下、合計最大+45点 (満点100点達成可能)**</td></tr>
        ...
        <tr><td class="desc-indiv-risk">**個別リスク評価**</td><td colspan="3">**DD率の連続減点とSL乖離の強化。最大-40点。**</td></tr>
        <tr><td>DD率 優秀</td><td>最大DD率 $\lt 1.0\%$</td><td>**+5点**</td><td>過去の損失リスクが極めて低い。</td></tr>
        <tr><td>DD率 連続減点</td><td>$2.0\% < \text{DD} \le 10.0\%$</td><td>**-2 * floor(DD-2.0)**</td><td>DD率に比例した減点 (強化)。</td></tr>
