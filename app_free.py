...
with col_title:
    ...
    <style>
        ...
        /* ヘッダー設定 (自然な配色に変更) */
        th { 
            background-color: #f0f2f6 !important; /* 目に優しい薄い青グレー */
            color: #31333F !important; /* 濃いグレー (真っ黒より自然) */
            font-weight: bold; 
            text-align: center;
            border: 1px solid #e0e0e0; /* 枠線もソフトに */
        ...
        td { 
            ...
            color: inherit; /* 文字色はユーザーのテーマ設定(白/黒)に従う */
        }
        ...
        th:nth-child(12), td:nth-child(12) { width: 110px; font-size: 11px; color: #0068c9; font-weight: bold; } /* バックテスト(青文字) */
